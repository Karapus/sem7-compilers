% option c++ % option noyywrap nodefault % {
...
% option yyclass = "yy::Lexer" % x comment

                                     wc[ \t\r] num([1 - 9][0 - 9] *) |
                   "0" id[a - zA - Z_][a - zA - Z_0 - 9] *
...
{num} {
  *yylval =
      new AST::ExprInt(*yyloc, llvm::APInt(sizeof(int) * 8, YYText(), 10));
...
.throw yy::parser::syntax_error(*yyloc,
